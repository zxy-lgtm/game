...
class GameGUI():
    ...
    def game_time(self):
        ...
        self.score+=1
        if self.score%2 == 0:
            self.screenParts["leftleg"] = ScreenObject("./image/leftleg.png",position1[0],position1[1])
            self.screenParts["rightleg"] = ScreenObject("./image/rightleg.png",poition2[0],poition2[1])
        elif self.score%4 == 1:
            self.screenParts["leftleg"] = ScreenObject("./image/leftleg.png",position1[0],position1[1]-50)
            self.screenParts["rightleg"] = ScreenObject("./image/rightleg.png",poition2[0],poition2[1])
        elif self.score%4 == 3:
            self.screenParts["leftleg"] = ScreenObject("./image/leftleg.png",position1[0],position1[1])
            self.screenParts["rightleg"] = ScreenObject("./image/rightleg.png",poition2[0],poition2[1]-50)
